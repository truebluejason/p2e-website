...
const rowStyle =
    window.innerWidth > 768 ? { display: 'flex', margin: 0 } : { margin: 0 };
    ...
    <div style={{ padding: 12 }}>
        ...
        <Row style={rowStyle}>
            <ContentBox>
                ...
                <p style={pStyle}>
                    A step by step meditation instructions. The section includes
                    pre-meditation checklist, intentions to hold during
                    meditation, and more.
                </p>
            </ContentBox>
            <ContentBox>
                ...
                <p style={pStyle}>
                    A multi-question checklist that highlights which area of
                    your meditation is going well and which area need more
                    attention. You should ideally be take this once per week.
                </p>
            </ContentBox>
            <ContentBox>
                ...
                <p style={pStyle}>
                    ...
                    how to appropriately counter each hindrance with its
                    antidote.
                </p>
            </ContentBox>
        </Row>
